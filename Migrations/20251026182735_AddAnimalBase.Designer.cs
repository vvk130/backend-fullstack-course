...
namespace backend_fullstack_course.Migrations
{
    ...
    [Migration("20251026182735_AddAnimalBase")]
    partial class AddAnimalBase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameModel.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GameModel.StockImg", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.OwnsMany("GameModel.PersonalityType", "Personalities", b1 =>
                        {
                            ...
                            b1.ToTable("Animal_Personalities");
            ...
            modelBuilder.Entity("GameModel.Question", b =>
                {
                    b.OwnsMany("GameModel.Option", "Options", b1 =>
                        {
                            ...
                            b1.Property<bool>("IsRightAnswer")
                                .HasColumnType("boolean");
